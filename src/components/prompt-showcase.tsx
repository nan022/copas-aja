  ...
  const showcaseItems = [
    {
      ...
      resultPreview: "/images/covers/marketing-category.png",
      resultType: "text",
      icon: MessageSquare,
    ...
    },
    {
      ...
      resultPreview: "/images/covers/kreatif-category.png",
      resultType: "image",
      icon: Image,
    ...
    },
    {
      ...
      resultPreview: "/images/covers/bisnis-category.png",
      resultType: "document",
      icon: BarChart,
    ...
    },
    {
      ...
      resultPreview: "/images/covers/edukasi-category.png",
      resultType: "slides",
      icon: MessageSquare,
    ...
    },
    {
      ...
      resultPreview: "/images/covers/teknis-category.png",
      resultType: "code",
      icon: Code,
    ...
    },
    {
      ...
      resultPreview: "/images/covers/content-category.png",
      resultType: "text",
      icon: MessageSquare,
